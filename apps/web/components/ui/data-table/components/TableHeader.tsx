...
const TableHeader = <TData extends RowData>({
  ...
  return (
    <div
      className="bg-primary-50 sticky top-0 z-1 flex items-center font-medium text-neutral-700"
      style={style}
    >
            ...
            return (
              ...
              >
                ...
                {header.column.getCanResize() ? (
                  <div
                    className='absolute top-0 right-0 bottom-0 z-2 w-[10px] cursor-col-resize touch-none select-none after:absolute after:right-0 after:inline-block after:h-full after:w-0.5 after:bg-neutral-200 after:content-[""] hover:after:w-1'
                  ...
                  >
                    {header.column.getIsResizing() ? (
                      <div
                        className="bg-primary absolute right-0 z-2 h-screen w-0.5 -translate-x-px touch-none select-none"
                        style={{
